...
<nav>
    ...
    <div class="content">
      ...
      if(isset($_POST['submit'])){
        $_name = mysqli_realescape_string($login_db, $_POST['text']);
        $_email = mysqli_realescape_string($login_db, $_POST['email']);
        $dob = mysqli_realescape_string($login_db, $_POST['dob']);
        $p_number = mysqli_realescape_string($login_db, $_POST['number']);
        $id = mysqli_realescape_string($login_db, $_POST['id']);
        $c_code = mysqli_realescape_string($login_db, $_POST['coarse_code']);
        $amount = mysqli_realescape_string($login_db, $_POST['amount']);
        $en_date = mysqli_realescape_string($login_db, $_POST['enroll_date']);
        $gender = mysqli_realescape_string($login_db, $_POST['gender']);
      ...
      ?>
        ...
        <div class="user-details">
          <div class="input-box">
            ...
            <input type="text" name="text" placeholder="Enter your name" value="<?php echo $result['text'];?>" required>
          </div>
